        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 shadow-lg p-6 mb-6">
          ...
          <div className="flex items-start justify-between gap-6">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Kurs Sil — draft/rejected ve isNew degilse */}
              {!isNew && (c.status === "draft" || c.status === "rejected") && (
                <button
                  onClick={() => {
                    if (confirm("Bu kursu kalici olarak silmek istediginize emin misiniz? Bu islem geri alinamaz.")) {
                      coursesApi.delete(id).then(() => {
                  ...
                  className="px-5 py-2.5 bg-red-500 hover:bg-red-600 text-white text-sm rounded-lg transition-all flex items-center gap-2 font-semibold"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
