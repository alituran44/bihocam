    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 md:p-8">
          ...
          {user?.role === "teacher" && (
            <div className="mb-6 bg-blue-50 border border-blue-200 rounded-2xl p-5 flex items-start gap-4">
              <span className="text-blue-500 text-2xl mt-0.5">ℹ️</span>
              <div>
                <p className="text-sm font-bold text-blue-800 mb-1">Profil Bilgileri ve Şifre Değiştir</p>
                <p className="text-xs text-blue-600 leading-relaxed">
                  Profil bilgilerinizi ve şifrenizi{" "}
                  <a href="/dashboard/teacher/profile" className="underline font-bold hover:text-blue-800">
                    Profil ve Finans
                  </a>{" "}
                  sayfasındaki <strong>Hesap Bilgileri</strong> ve <strong>Şifre Değiştir</strong> sekmelerinden yönetebilirsiniz.
                </p>
              </div>
            </div>
          )}
