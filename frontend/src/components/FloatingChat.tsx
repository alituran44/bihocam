            ...
            <div className="p-4 space-y-3">
              ...
              {user?.role === "teacher" ? (
                <button
                  onClick={() => {
                    setOpen(false);
                    router.push("/dashboard/teacher/ai-assistant");
                  }}
                  className="w-full flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 border border-purple-200 rounded-2xl transition-all group"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/30 flex-shrink-0 group-hover:scale-110 transition-transform text-white text-xl">
                    ✨
                  </div>
                  <div className="text-left flex-1">
                    <p className="font-bold text-gray-900 text-sm">Eğitmen AI Asistanı</p>
                    <p className="text-xs text-gray-500 mt-0.5">Ders planı & materyal önerileri</p>
                    <p className="text-xs text-gray-400 mt-1">Sana Özel Rehberlik</p>
                  </div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200 rounded-2xl transition-all group"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 flex-shrink-0 group-hover:scale-110 transition-transform text-white text-xl">
                    ✨
                  </div>
                  <div className="text-left flex-1">
                    <p className="font-bold text-gray-900 text-sm">Öğrenci AI Asistanı</p>
                    <p className="text-xs text-gray-500 mt-0.5">Derslerde anlamadıklarını sor</p>
                    <p className="text-xs text-gray-400 mt-1">7/24 Kesintisiz Destek</p>
                  </div>
